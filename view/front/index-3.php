...
<div class="content pt1"><div class="ic"></div>
  <div class="container_12">
     <div class="grid_7">
      <h2>Blog</h2><br>
      <div class="blog">
        <img src="images/page4_img1.jpg" alt="" class="img_inner fleft i1">
      ...
      <div class="blog">
        ...
        <div class="extra_wrapper">
          <div class="text2 col2">Alunc fringilla diam sit amet adipi scing bibendum turpis velit feugiat urna etlort. </div>Wivamus est quam dapibus ullamcolot rperolty hoki. Hibh ullamcorper accufogy msan sem lectus ut sapien. 
        </div>
        <div class="clear"></div>Traesent quis orci eget diam viverra consequat. Fusce sagittis quam in pulvinar sollicitudin velit velit cursus nibh ullamcorper accumsan sem lectus ut sapien. Donec venenatis posuere velit aty convallis neque ullamcorper quis. Integer posuere ipsum eu risus sollicitudin nec varius eratylo luctus. Kusce fringilla erat ac urna pe llentesque congue. Ounc fringilla diam sit amet adipi scing bibendum turpis velit feugiat urna et pharetra neque nisi ac nunc. Vivamus est quam dapibuslok. Ullamco rper imperdiet nec euismod ut arcu. Nulla facilisi. Plotiam mauris lorem pulvinar vel.
        <br>
        <a href="#" class="btn">More</a>
      </div>
      <div class="blog">
        <img src="images/page4_img3.jpg" alt="" class="img_inner fleft i1">
        <div class="extra_wrapper">
          <div class="text2 col2">Bunc ringillo diam sit amet adipi scing bibendum turpis velit feugiat urna ety.</div>Qpivamus est quam dapibus ullamcolot rperolty hoki. Kibh ullamcorper accufogy msan sem lectus ut sapien monecjoili. 
        </div>
     ...
     <div class="grid_4 prefix_1">
       ...
       <ul class="list1">
         <li>
           <span></span>
             <div class="extra_wrapper">
           <div class="col1"><a href="#">Tuis posuere consectetur pellente</a></div></div>
         </li>
         <li>
           <span class="cnt"></span><div class="extra_wrapper">
           <div class="col1"><a href="#">Juuis posuere consectetur pellente</a></div></div>
         </li>
         <li>
           <span></span> <div class="extra_wrapper">
           <div class="col1"><a href="#">Dpuis posuere honsectetur pellentio</a></div></div>
         </li>
         <li>
           <span class="cnt"></span> <div class="extra_wrapper">
           <div class="col1"><a href="#">Kouis losuere honsectetur pellentit</a></div></div>
         </li>
         <li>
           <span ></span> <div class="extra_wrapper">
           <div class="col1"><a href="#">Opuis posuere monsectetur pellentlo</a></div></div>
         </li>
         <li>
           <span class="cnt"></span> <div class="extra_wrapper">
           <div class="col1"><a href="#">Jupuis posuere loonsectetur kellen</a></div></div>
         </li>
         <li>
           <span class=""></span> <div class="extra_wrapper">
           <div class="col1"><a href="#">Kiloiy posuere onsectrytr koelltlo</a></div></div>
         </li>
         <li>
           <span class="cnt"></span> <div class="extra_wrapper">
           <div class="col1"><a href="#">Derfis posuere sectetur golillentlo</a></div></div>
         </li>
          <li>
           <span class=""></span> <div class="extra_wrapper">
           <div class="col1"><a href="#">Hokipuis koloosue jolonsectetur holo</a></div></div>
         </li>
       </ul>
       <h2 class="head1">Recent Posts</h2>
        <ul class="list l2">
         <li>
           <span>
             <time datetime="2013-01-01">26<span>APR</span></time></span>
             <div class="extra_wrapper">
           <div class="col1"><a href="#">Duis posuere consectetur pellentesqe</a></div>Sed nisi turpis, pellentesque at ultricese in dapibus in magna. Nunc easi cipit eu ante. Nullam vitae dolor.  <a href="#" class="col2">Read More</a> </div>
         </li>
         <li>
           <span class="cnt">
             <time datetime="2013-01-01">27<span>APR</span></time></span> <div class="extra_wrapper">
           <div class="col1"><a href="#">Kuuis posuere consectetur pellentes</a></div>Eed nisi turpis, pellentesque at ultricesy in dapibus. Nunc easi diam risulacerate ut scelerisque et sus ante.  <a href="#" class="col2">Read More</a> </div>
         </li>
         <li>
           <span>
             <time datetime="2013-01-01">28<span>APR</span></time></span> <div class="extra_wrapper">
           <div class="col1"><a href="#">Opuis posuere honsctetur pellentesyt</a></div>Koed joliko hokino lytocio. Nunc easiloto diam sujo placerat ut scelerisque  suyto
scipit ante. Ullam ullcper. <a href="#" class="col2">Read More</a></div>
         </li>
          <li>
           <span class="cnt">
