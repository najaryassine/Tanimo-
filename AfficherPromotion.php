<?php
  ...
  $sql = "SELECT id,produit,prixancien,prixnouveau FROM promotion";
    ...
    <ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
      <li class="menu-item">
        ...
        <ul id="veterinaire-page" class="collapse" aria-labelledby="veterinaire-page" data-parent="#side-nav-accordion">
          <li> <a href="../veterinaire/ajouterveterinaire.html">Ajouter Un vétérinaire</a> </li>
          <li> <a href="../veterinaire/AfficherVeterinaire.php"> Liste des vétérinaires</a> </li>
      ...
      <li class="menu-item">
              ...
              <ul id="veterinaire-page" class="collapse" aria-labelledby="veterinaire-page" data-parent="#side-nav-accordion">
                <li> <a href="promotion/AfficherPromotion.php">Ajouter Une promotion</a> </li>
