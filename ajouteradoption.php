...
<form action="ajouteradoption.php" method="POST" enctype="multipart/form-data" >
   ...
   <label for="validationCustom10">espece</label>
                      <div class="input-group">
                        <input type="text" name="espece" class="form-control" id="espece" placeholder="Entrer le espece " required="">
 ...
 <br>
                    ...
                    <label for="validationCustom10">Race</label>
                      <div class="input-group">
                        <input type="text" name="race" class="form-control" id="race" placeholder="Entrer le race " required="">
                          <div class="invalid-feedback">
                            Nom
                          </div>
                      </div>

       <label for="validationCustom10">sexe</label>
                      <div class="input-group">
                        <input type="text" name="sexe" class="form-control" id="sexe" placeholder="Entrer le sexe " required="">
                   ...
                   <br>
                   <label for="validationCustom10">age</label>
                      <div class="input-group">
                        <input type="text" name="age" class="form-control" id="age" placeholder="Entrer lage " required="">
                         
                      </div>


 <br>
 <label for="validationCustom10">region</label>
                      <div class="input-group">
                        <input type="text" name="region" class="form-control" id="region" placeholder="Entrer le region " required="">
