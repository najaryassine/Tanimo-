...
<form method="post" action="actions/modifierVet.php?id=<?php echo $_GET["id"] ?>" enctype="multipart/form-data" name="form">
                    ...
                    <div class="ms-panel-body">
                        <form class="needs-validation clearfix" novalidate="">
                            <div class="form-row">
                                ...
                                <div class="col-md-12">
                                    <button class="btn btn-dark mr-2  ms-graph-metrics"> <a href="vetUpdate.php?id=<?php echo $_GET["id"] ?>">Vider </a> </button>
